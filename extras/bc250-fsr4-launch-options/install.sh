...
PLUGIN_NAME="BC-250 FSR4 Launch Options"
...
[[ -f "$SOURCE_DIR/plugin.json" && -f "$SOURCE_DIR/main.py" && -f "$SOURCE_DIR/dist/index.js" ]] || {
    echo "BC-250 FSR4 Launch Options artifact is incomplete." >&2; exit 1; }
...
echo "BC-250 FSR4 Launch Options installed. Open it from Decky's Quick Access Menu."
