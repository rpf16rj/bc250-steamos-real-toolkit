...
1. Download the [**latest release**](https://github.com/rpf16rj/bc250-steamos-real-toolkit/releases/latest) zip on your SteamOS machine (Desktop Mode, or `Download` on the releases page).
