...
- `vcn.md` — VCN 2.0.3 ungate investigation — CONCLUDED: block is electrically dead (PGFSM_STATUS read wedges the fabric), HW decode impossible; diagnostic patch + EFI-breadcrumb technique documented
